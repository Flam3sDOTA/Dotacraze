...
LinkLuaModifier( "modifier_enchantress_natures_attendants_lua", "lua_abilities/modifiers/modifier_enchantress_natures_attendants_lua", LUA_MODIFIER_MOTION_NONE )
