...
LinkLuaModifier( "modifier_bristleback_quill_spray_lua", "lua_abilities/modifiers/modifier_bristleback_quill_spray_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_bristleback_quill_spray_lua_stack", "lua_abilities/modifiers/modifier_bristleback_quill_spray_lua_stack", LUA_MODIFIER_MOTION_NONE )
